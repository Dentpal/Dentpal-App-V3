  ...
  Widget _buildActiveFiltersChips() {
    ...
    if (_currentFilters.categoryIds.isNotEmpty) {
      for (String categoryId in _currentFilters.categoryIds) {
        ...
        chips.add(_buildActiveFilterChip('Category: ${category.categoryName}', () {
          AppLogger.d('🗑️ Removing category filter: ${category.categoryName}');
          setState(() {
            List<String> newCategoryIds = List.from(_currentFilters.categoryIds);
          ...
          AppLogger.d('🗑️ Category filter cleared, performing search');
          _performSearch();
        }));
      }
    }
    ...
    if (_currentFilters.minPrice != null || _currentFilters.maxPrice != null) {
      ...
      chips.add(_buildActiveFilterChip(priceText, () {
        AppLogger.d('🗑️ Removing price filter');
        setState(() {
          _currentFilters = _currentFilters.copyWith(
            minPrice: null,
            maxPrice: null,
        ...
        AppLogger.d('🗑️ Price filter cleared, performing search');
        _performSearch();
      }));
    }
      ...
      child: Row(
        ...
        children: [
          ...
          Material(
            ...
            child: InkWell(
              onTap: () {
                AppLogger.d('🗑️ Removing filter: $label');
                onRemove();
              },
