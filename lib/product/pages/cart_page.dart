...
class _CartPageState extends State<CartPage>
  ...
  void initState() {
    ...
    if (_instance != null) {
      ...
      //AppLogger.d("CartPage initState called, cached: ${_cachedSellerGroups != null}, items: ${_cachedSellerGroups?.length ?? 0}",);
  ...
  Future<List<SellerGroup>> _loadSellerGroups() async {
    ...
    if (_cachedSellerGroups != null && _lastCacheTime != null) {
      ...
      if (cacheAge < _cacheDuration) {
        ...
        //AppLogger.d("Cache expired (${cacheAge.inMinutes} minutes old), refreshing",);
      }
  ...
  void _onUpdateQuantity(CartItem item, int newQuantity) async {
    ...
    try {
      //AppLogger.d("Updating cart item quantity: ${item.cartItemId} to $newQuantity",);
